...
type ComplexityRoot struct {
	...
	Query struct {
		Comics func(childComplexity int, name string) int
	}
}

type QueryResolver interface {
	Comics(ctx context.Context, name string) ([]*model.Comic, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.comics":
		...
		return e.complexity.Query.Comics(childComplexity, args["name"].(string)), true
...
func (ec *executionContext) _Query_comics(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Comics(rctx, args["name"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNComic2ᚕᚖgithubᚗcomᚋbickyericᚋarumbaᚋmodelᚐComic(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNComic2ᚕᚖgithubᚗcomᚋbickyericᚋarumbaᚋmodelᚐComic(ctx context.Context, sel ast.SelectionSet, v []*model.Comic) graphql.Marshaler {
